...
export default {
    ...
    methods: {
        uploadFile() {
            ...
            this.form.thumbnails = files;
            Array.from(files).forEach((file) => {
                this.thumbnails_previews.push(URL.createObjectURL(file));
            });
        },
        deleteThumbnail(index) {
            this.thumbnails_previews.splice(index, 1);
        },
        addExtra() {
        ...
        createGig() {
            ...
            this.form.post(route("gigs.store"), {
                preserveScroll: true,
            });
        },
    },
                ...
                <div class="lg:col-span-3 p-4 bg-white">
                    <form @submit.prevent="createGig">
                        ...
                        <div class="mb-4">
                            ...
                            <div
                                v-if="thumbnails_previews.length > 0"
                                class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4"
                            >
                                <div
                                    v-for="(
                                        image, index
                                    ) in thumbnails_previews"
                                    class="relative"
                                >
                                    <button
                                        type="button"
