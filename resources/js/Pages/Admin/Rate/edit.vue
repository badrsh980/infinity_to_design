...
export default {
    ...
    methods: {
        update() {
            this.form.post(route("admin.rates.update"), {
                preserveScroll: true,
                onError: (errors) => {
                    console.log(errors);
                },
    ...
    mounted() {
        this.form.name =
            this.rate.namethis.form.count =
            this.rate.countthis.form.review_id =
            this.rate.review_idthis.form.gig_id =
                this.rate.gig_id;
    },
};
</script>
    ...
    <AdminLayout>
        <div class="w-3/4 mx-auto p-4 bg-white">
            <form @submit.prevent="update">
                ...
                <div class="mb-4">
                    <InputLabel for="count" :value="$t('message.count')" />
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="review_id"
                        class="border-gray-500 rounded-sm shadow-sm w-full"
                        v-model="form.review_id"
                    />

                    <InputError class="mt-2" :message="form.errors.review_id" />
                </div>
