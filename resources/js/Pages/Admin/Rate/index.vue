    ...
    <AdminLayout>
        <div class="mt-12 p-6 bg-gray-50">
            <div class="my-6 flex justify-between items-center">
                <div></div>
                <div>
                    <a class="p-4 font-normal text-base bg-primary-light text-white" :href="route('admin.rates.create')">{{ $t('message.add') }}</a>
                </div>
            </div>
            <div class="my-6">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    >
                        ...
                        >
                            <tr>
                                <th scope="col" class="px-6 py-3">{{ $t("message.name") }}</th>
<th scope="col" class="px-6 py-3">{{ $t("message.count") }}</th>
<th scope="col" class="px-6 py-3">{{ $t("message.review_id") }}</th>
<th scope="col" class="px-6 py-3">{{ $t("message.gig_id") }}</th>
                        ...
                        <tbody>
                            <tr
                                ...
                                v-for="rate in rates"
                            >
                                <td class="px-6 py-4" v-text="rate.name"></td>
<td class="px-6 py-4" v-text="rate.count"></td>
<td class="px-6 py-4" v-text="rate.review_id"></td>
<td class="px-6 py-4" v-text="rate.gig_id"></td>
