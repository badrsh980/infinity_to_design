    ...
    <AdminLayout>
        <div class="mt-12 p-6 bg-gray-50">
            <div class="my-6 flex justify-between items-center">
                <div></div>
                <div>
                    <a class="p-4 font-normal text-base bg-primary-light text-white" :href="route('admin.notifications.create')">{{ $t('message.add') }}</a>
                </div>
            </div>
            <div class="my-6">
...
<th scope="col" class="px-6 py-3">{{ $t("message.notifiable_type") }}</th>
<th scope="col" class="px-6 py-3">{{ $t("message.notifiable_id") }}</th>
<th scope="col" class="px-6 py-3">{{ $t("message.data") }}</th>
<th scope="col" class="px-6 py-3">{{ $t("message.read_at") }}</th>
                        ...
                        <tbody>
                            ...
                            >
                                <td class="px-6 py-4" v-text="notification.type"></td>
<td class="px-6 py-4" v-text="notification.notifiable_type"></td>
<td class="px-6 py-4" v-text="notification.notifiable_id"></td>
<td class="px-6 py-4" v-text="notification.data"></td>
<td class="px-6 py-4" v-text="notification.read_at"></td>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <a
                                        :href="
                                            route('admin.notifications.show', {
                                                notification: notification.id,
                                            })
                                        "
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1"
